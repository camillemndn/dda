...
#' @param basisobj PARAM_DESCRIPTION
#' @param cvec PARAM_DESCRIPTION, Default: FALSE
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples 
#' \dontrun{
...
#' @description FUNCTION_DESCRIPTION
#' @param basisobj PARAM_DESCRIPTION
#' @param cvec PARAM_DESCRIPTION
#' @param JMAX PARAM_DESCRIPTION, Default: 15
#' @param EPS PARAM_DESCRIPTION, Default: 1e-07
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples 
#' \dontrun{
...
#' @param basisobj PARAM_DESCRIPTION
#' @param cvec PARAM_DESCRIPTION
#' @param Cval PARAM_DESCRIPTION, Default: 1
#' @param nderiv PARAM_DESCRIPTION, Default: 0
#' @param JMAX PARAM_DESCRIPTION, Default: 15
#' @param EPS PARAM_DESCRIPTION, Default: 1e-07
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
...
#' @param cvec PARAM_DESCRIPTION
#' @param Cval PARAM_DESCRIPTION, Default: 1
#' @param nderiv1 PARAM_DESCRIPTION, Default: 0
#' @param nderiv2 PARAM_DESCRIPTION, Default: 0
#' @param JMAX PARAM_DESCRIPTION, Default: 15
#' @param EPS PARAM_DESCRIPTION, Default: 1e-07
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
...
#' @title FUNCTION_TITLE
#' @description FUNCTION_DESCRIPTION
#' @param xa PARAM_DESCRIPTION
#' @param ya PARAM_DESCRIPTION
