...
```{r vnt_ten_periods_preprocessing, eval = FALSE}
...
```{r vnt_ten_periods_out_compute, eval = FALSE}
...
if (!file.exists("ICS_climate_change_out.RData") && !file.exists("ICS_climate_change.RData")) {
...
if (!file.exists("ICS_climate_change_out.RData")) {
  ...
  save(ics_out, file = "ICS_climate_change_out.RData")
}
```

```{r climate_regions_grid_out}
load("ICS_climate_change_out.RData")
