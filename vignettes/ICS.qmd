...
if (!(file.exists("ICS_comparison_data.RData"))) {
...
ggplot(comparison_avg, aes(FPR_avg, TPR_avg, color = Scheme, group = Scheme)) +
  geom_line() +
  geom_ribbon(aes(ymin = pmax(0, TPR_avg - TPR_conf), ymax = pmin(1, TPR_avg + TPR_conf), fill = Scheme), alpha = 0.1, linetype = "dotted") +
