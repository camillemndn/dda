...
simulation_gp_clr <- function(n, p = 100) {
...
simulation_gumbel <- function(n, p = 100, outlier_rate = 0.02, deterministic = TRUE) {
...
simulation_gp_margin <- function(n, p = 100) {
...
ggplot(comparison_avg, aes(FPR_avg, TPR_avg, color = Method, group = Method)) +
  geom_line() +
  geom_ribbon(aes(ymin = pmax(0, TPR_avg - TPR_conf), ymax = pmin(1, TPR_avg + TPR_conf), fill = Method), alpha = 0.1, linetype = "dotted") +
