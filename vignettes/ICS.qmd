...
#|  - ICS eigendensities.
#|  - Shifting the mean in the direction of each ICS eigendensity.
#| fig-width: 7.5
#| fig-height: 5
#| layout-ncol: 2
...
#| fig-cap:
#|  - Densities of maximum temperature in the provinces of the S3 climate region of Vietnam during the years 1987-2016.
#|  - Centred log-ratio transforms of the centred densities of maximum temperature in the provinces of the S3 climate region of Vietnam during the years 1987-2016.
#| fig-width: 7.5
#| fig-height: 5
#| layout-ncol: 2
...
ics_grid_out |>
  ...
  mutate(n_outlying = sum(outlying)) |>
  ggplot(aes(log10(lambda), year, alpha = n_outlying)) +
  geom_tile() +
  scale_alpha_continuous(range = c(0, 1)) +
  facet_grid(cols = vars(nknots), rows = vars(index_select)) +
  labs(y = "year", alpha = "outlier\nfrequency")
